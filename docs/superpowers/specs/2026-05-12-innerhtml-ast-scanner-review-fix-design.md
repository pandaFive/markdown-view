...
- `Object.assign(target, { innerHTML: value })`、`Object.assign(target, ({ innerHTML: value }))`、`Object.assign(target, { ["innerHTML"]: value })`、`Object.assign(target, { [("innerHTML")]: value })`、`Object.assign(target, { ...{ innerHTML: value } })`、`Object["assign"](...)`、`(Object.assign)(...)`、`(Object).assign(...)` の source object top-level property
...
- `Reflect.set(target, "innerHTML", value)`、`Reflect.set(target, ("innerHTML"), value)`、`Reflect["set"](target, "innerHTML", value)`、`(Reflect.set)(...)`、`(Reflect).set(...)`
- `Object.defineProperty(target, "innerHTML", descriptor)`、`Object.defineProperty(target, ("innerHTML"), descriptor)`、`Object["defineProperty"](...)`、`(Object.defineProperty)(...)`、`(Object).defineProperty(...)`
- `Object.defineProperties(target, { innerHTML: descriptor })`、`Object.defineProperties(target, ({ innerHTML: descriptor }))`、`Object.defineProperties(target, { ...{ innerHTML: descriptor } })`、`Object.defineProperties(target, { innerHTML })`、`Object["defineProperties"](...)`、`(Object.defineProperties)(...)`、`(Object)["defineProperties"](...)` の descriptor object top-level property
