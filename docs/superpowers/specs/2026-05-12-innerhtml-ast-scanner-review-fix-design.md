...
- `Object.assign(target, { innerHTML: value })`、`Object.assign(target, ({ innerHTML: value }))`、`Object.assign(target, { ["innerHTML"]: value })`、`Object.assign(target, { [("innerHTML")]: value })`、`Object.assign(target, { ...{ innerHTML: value } })`、`Object["assign"](...)`、`(Object.assign)(...)`、`(Object).assign(...)`、`(0, Object.assign)(...)` の source object top-level property
- Unicode escape / parenthesized callee object の `\u004fbject.assign(...)`、`\u004fbject["defineProperties"](...)`、`\u0052eflect.set(...)`、`(Object)["defineProperties"](...)`、`(Reflect).set(...)`
...
- `Reflect.set(target, "innerHTML", value)`、`Reflect.set(target, ("innerHTML"), value)`、`Reflect["set"](target, "innerHTML", value)`、`(Reflect.set)(...)`、`(Reflect).set(...)`、`(0, Reflect.set)(...)`
- `Object.defineProperty(target, "innerHTML", descriptor)`、`Object.defineProperty(target, ("innerHTML"), descriptor)`、`Object["defineProperty"](...)`、`(Object.defineProperty)(...)`、`(Object).defineProperty(...)`、`(0, Object.defineProperty)(...)`
- `Object.defineProperties(target, { innerHTML: descriptor })`、`Object.defineProperties(target, ({ innerHTML: descriptor }))`、`Object.defineProperties(target, { ...{ innerHTML: descriptor } })`、`Object.defineProperties(target, { innerHTML })`、`Object["defineProperties"](...)`、`(Object.defineProperties)(...)`、`(Object)["defineProperties"](...)`、`(0, Object["defineProperties"])(...)` の descriptor object top-level property

## Residual Risk

dynamic alias、dynamic computed key、dynamic object spread、dynamic sequence callee は残リスクとして受け入れる。例: `const p = "innerHTML"; target[p] = html`、`target[innerHTML] = html`、`Object.assign(target, { [innerHTML]: html })`、`Object.assign(target, { ...source })`、`(0, Object[assign])(target, { innerHTML: html })` は test-only scanner では検出しない。また値の由来は追跡しない。許可リスト更新時は、検出された sink の値が `SanitizedHtml` 由来、または空文字 clear であることを人間レビューで確認する。
